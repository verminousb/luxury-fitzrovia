...
export const NEIGHBORHOOD_DATA: Record<LocationCategory, Attraction[]> = {
  ...
  [LocationCategory.SHOPPING]: [
    ...
    { name: "Regent Street", category: "shop", description: "Grand architecture housing Apple, Hamleys, and premium brands.", distance: "8 min walk" },
  ...
  [LocationCategory.CULTURE]: [
    ...
    { name: "BT Tower", category: "attraction", description: "An iconic landmark of the London skyline, right on your doorstep.", distance: "1 min walk" },
...
export const PROPERTY_STATS = [
  ...
  { label: 'Beds', value: '3', icon: (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 20h20"/><path d="M6 16v-4a2 2 0 1 1 4 0v4"/><path d="M2 10h20"/><path d="M14 16v-4a2 2 0 1 1 4 0v4"/><path d="M6 10V6a2 2 0 1 1 4 0v4"/><path d="M14 10V6a2 2 0 1 1 4 0v4"/></svg>
  )},
